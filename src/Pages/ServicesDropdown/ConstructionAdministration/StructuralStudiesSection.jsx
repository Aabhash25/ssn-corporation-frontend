...
const StructuralStudiesSection = ({ structuralStudiesData }) => {
  const renderServiceCard = (service) => {
    return (
      <div
        key={service.id}
        className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-gray-200 p-6"
      >
        <h3 className="text-lg md:text-xl font-bold text-gray-900 font-playfair mb-3">
          {service.title}
        </h3>
      ...
      <div className="mx-auto w-full sm:w-[90%] lg:w-[80%]">
        <div className="text-center mb-12">
          <span className="block mb-2 text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-400 font-playfair">
            Our Construction Administration Solutions
          </span>
        </div>
