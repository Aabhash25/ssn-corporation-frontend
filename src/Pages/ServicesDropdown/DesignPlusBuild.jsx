        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto space-y-10">
          ...
          <div>
            ...
            <p className="text-lg font-roboto text-gray-700 leading-relaxed">
              ...
              In-house designers, engineers, planners, and construction
              specialists operate within one coordinated team. This eliminates
              communication gaps, reduces delays, and ensures that every detail
              stays aligned with the goals you set from day one.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg font-roboto text-gray-700 leading-relaxed">
              Before introducing design concepts, our team of
              designers,engineers, planners, and construction specialists
