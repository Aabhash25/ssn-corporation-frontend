              ...
              <div className="mt-auto">
                ...
                >
                  <div className="space-y-3 lg:space-y-4 pr-2">
                    ...
                    {/* <div className="pt-4 lg:pt-6 mt-4 lg:mt-6 border-t border-white/20">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          // Handle learn more action
                        }}
                        className="px-4 py-2 sm:px-6 sm:py-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white font-medium text-sm sm:text-base rounded-lg transition-all duration-300 hover:scale-105 transform"
                      >
                        View Case Study
                      </button>
                    </div> */}
  ...
  return (
    <section className="relative w-full py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
      <div className="mx-auto w-full sm:w-[90%] lg:w-[80%]">
        ...
        {/* Geotechnical Studies Row */}
        {renderServiceRow(geotechnicalStudiesData)}
      </div>
    </section>
  );
};
