          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="group flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  We coordinate structural engineering with geotechnical, civil,
                  and transportation disciplines to provide efficient and
            ...
            <div className="group flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  ...
                  consider constructability, project requirements, and long-term
                  performance.
                </p>
              </div>
            </div>
