export const services = [
  ...
  {
    title: "Residential, Commercial, and Institutional Engineering Services",
    icon: "🏢",
    image: "/MorisvilleCommercial2.webp",
    description:
      "SSN Engineers provides structural, civil site, and building systems engineering services supporting residential, commercial, and specialized facilities including healthcare, industrial, and educational projects. The key areas are:",
    features: [
      "Residential and commercial site/civil engineering",
      "Healthcare facility engineering support",
      "Infrastructure and utility planning",
      "Industrial and manufacturing facility engineering",
      "Educational facility engineering support",
    ],
  },
  {
